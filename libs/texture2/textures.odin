...
lua_load_texture_handle :: proc "c" (L: ^lua.State) -> i32 {
    ...
    // 1. Load the image using your image module
    ...
    // 3. Push the handle as a light userdata (or integer) to Lua
    //    This avoids creating a full userdata per texture!
...
lua_texturelib := []lua.L_Reg {
	...
	{"load_texture_handle", lua_load_texture_handle },
	{"draw_texture_handle", lua_texture_draw_handle },
	{"free_texture_handle", lua_texture_free_handle },
	{"draw", lua_draw},
